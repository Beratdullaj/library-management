...
export default {
  ...
  props: {
    menaxhimiLibrariseId: String,
    initialFiles: String,
  },
  data() {
    return {
      dropzoneOptions: {
        url: `http://localhost:4000/menaxhimi-librarise/${this.menaxhimiLibrariseId}/uploadFile`,
        method: "put",
        thumbnailWidth: 300,
        maxFilesize: 2,
        addRemoveLinks: true,
  ...
  methods: {
      ...
      removeFile(file){
        apiRequest.removeFile(this.menaxhimiLibrariseId, file);
      },
